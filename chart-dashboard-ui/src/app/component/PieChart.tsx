...
import LoadingErrorComponent from "./LoadingErrorComponent"; // Import the reusable component

// Define specific types for PieChart
...
const PieChart = () => {
  ...
  // Render the pie chart if data is successfully loaded
  return (
    <Chart
      chartType="PieChart"
      width="100%"
      ...
      options={{
        title: "Pie Chart",
        is3D: true, // Adds a 3D effect to the pie chart
      }}
    />
  );
};
